...
data_dir = join(home, 'DataDir_EddyCuda')
workflow_dir = join(home, 'Workflow_EddyCuda')
home
...
template = dict(mask = join(home,'2_Transfer/{subject_id}/{subject_id}_ses-shapesV1_T1w_resample_brain_mask.nii.gz'),
                dti = join(home,'2_Transfer/{subject_id}/resampled_dropped_denoised_gibbs_biascorr_corrected_reoriented_flirt.nii.gz'),
                bval = join(home,'2_Transfer/{subject_id}/{subject_id}_ses-shapesV1_dwi.bval'),
                bvec = join(home,'2_Transfer/{subject_id}/{subject_id}_ses-shapesV1_dwi.bvec'),
...
eddy_flow.connect([(infosource, sf,[('subject_id','subject_id')]),
                   ...
                   (eddy, datasink, [('out_corrected','3_Eddy_Corrected'),
                                    ...
                                    ('out_movement_rms','3_Eddy_Corrected.@par.@par'),
