...
template = dict(dti = join(proc_dir,'3_Eddy_CUDA_Corrected/{subject_id}/eddy_corrected.nii.gz'),
                bval = join(proc_dir,'3_Eddy_CUDA_Corrected/{subject_id}/{subject_id}_ses-shapesV1_dwi.bval'),
                bvec = join(proc_dir,'3_Eddy_CUDA_Corrected/{subject_id}/eddy_corrected.eddy_rotated_bvecs'),
                t1 = join(rawdir, '{subject_id}/anat/{subject_id}_ses-shapesV1_T1w.nii.gz')
               )
